...
class DetailDoctor extends Component {
    ...
    async componentDidMount() {
        if (this.props.match && this.props.match.params && this.props.match.params.id) {
            ...
            // console.log('check detail doctor', res)
        }
    }
    ...
    render() {
        ...
        if (detailDoctor && detailDoctor.positionData) {
            nameEn = `${detailDoctor.firstName} ${detailDoctor.lastName}, ${detailDoctor.positionData.valueEn}`
            nameVi = `${detailDoctor.lastName} ${detailDoctor.firstName}, ${detailDoctor.positionData.valueVi}`
        }
